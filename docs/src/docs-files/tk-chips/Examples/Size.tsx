...
const Size = () => {
  const reactCode = `<TkChips variant="primary" size="small" type="filled" label="primary" removable />
...
<TkChips variant="primary" size="large" type="filled" label="primary" removable />`;
  ...
  const vueCode = `<TkChips variant="primary" size="small" type="filled" label="primary" removable />
<TkChips variant="primary" size="base" label="primary" removable />
<TkChips variant="primary" size="large" type="filled" label="primary" removable />`;

  const angularCode = `<tk-chips variant="primary" size="small" type="filled" label="primary" removable />
<tk-chips variant="primary" size="base" label="primary" removable />
<tk-chips variant="primary" size="large" type="filled" label="primary" removable />`;
