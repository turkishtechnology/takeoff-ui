...
Avatars have shadow effect by default. Use `hideShadow` property to remove the shadow effect.

<TkAlert header="Note" variant="info" message="When badge is present, shadow is always applied regardless of hideShadow property." filledlight />
<br/>
<WithShadow />
