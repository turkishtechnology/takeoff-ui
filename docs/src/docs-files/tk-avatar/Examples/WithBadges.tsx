...
<tk-avatar label="AD" badge badgeStatus="danger" rounded />`;
  ...
  const demo = (
    <div className="flex justify-center gap-2 flex-wrap">
      <TkAvatar image={useBaseUrl('img/docs/tk-avatar/user-1.png')} background="solid" badge badgeStatus="success" rounded />
      <TkAvatar image={useBaseUrl('img/docs/tk-avatar/user-2.png')} background="solid" badge badgeStatus="warning" rounded />
      <TkAvatar label="AD" badge badgeStatus="danger" rounded />
    </div>
  );
