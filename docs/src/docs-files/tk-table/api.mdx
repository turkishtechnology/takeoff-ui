...
| <TkBadge label="expandedRowStyle" variant="primary" size="large" type="filledlight"/> | <code>(row: any)=>any</code> | null | Provides a function to customize the container styles for expanded row content. This function receives the expanded row data and should return a style object. |
