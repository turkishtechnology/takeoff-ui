...
| <TkBadge label="rowStyle" variant="primary" size="large" type="filledlight"/> | <code>(row: any)=>ITableRowCellStyleResponse</code> | null | Provides a function to customize row styles. This function takes row information and returns a style for a specific row. |
...
| <TkBadge label="selectionRowDisabled" variant="primary" size="large" type="filledlight"/> | <code>Function</code> | null |  |
