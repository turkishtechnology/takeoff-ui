...
<tk-divider [mx]="0">Vertical None</tk-divider>`;
  ...
  const demo = (
    <div className="flex flex-col gap-4">
      <div style={{ borderColor: 'var(--primary-700)' }} className="py-0 px-2 border border-dashed rounded-lg">
        <TkDivider my={32}>
          <div className="flex items-center gap-2">
            <span>Horizontal</span>
            <TkButton label="button" size="small" variant="info" type="filled" icon="content_paste_search"></TkButton>{' '}
      ...
      <div style={{ borderColor: 'var(--primary-700)' }} className="border border-dashed rounded-lg">
        <TkDivider mx={0}>Vertical None</TkDivider>
      </div>
    </div>
  );
