  ...
  const demo = (
    <>
      <div className="mb-4 flex flex-col gap-2">
        ...
        <TkAlert variant="info" type="outlined" header="Success Filled Alert" message="Lorem Ipsum is simply dummy text of the printing and typesetting industry.">
          <div slot="right-action" className="flex gap-3">
            <TkButton label="Action1" variant="info" type="text" />
            <TkButton label="Action2" variant="info" type="text" />
          </div>
        ...
        <TkAlert variant="info" type="outlined" header="Success Filled Alert" message="Lorem Ipsum is simply dummy text of the printing and typesetting industry.">
          <div slot="footer-action" className="flex gap-3">
            <TkButton label="Action1" variant="info" type="outlined" size="small" />
            <TkButton label="Action2" variant="info" type="filled" size="small" />
          </div>
        </TkAlert>
      </div>
    </>
