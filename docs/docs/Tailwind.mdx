...
A Tailwind CSS plugin that transforms Takeoff UI Design System variables into
utility classes and responsive components.
...
- Other Primitive Colors: `red-`, `blue-`, `green-`, `yellow-`, `purple-`,
  `cyan-`, `teal-`, `business-`
