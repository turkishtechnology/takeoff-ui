...
import V2Notice from '../src/components/V2Notice/V2Notice';

# Installation

<V2Notice title="Installing for a new project? Start with Takeoff UI v2">
  Takeoff UI v2 is the current generation of the design system and is what new
  React projects should install. Follow the steps below only if you are working
  on an existing Takeoff UI v1 project, if you are on Angular or Vue, or if you
  have a specific reason to stay on v1.
</V2Notice>
