...
components developed with [Stencil.js](https://stenciljs.com/). The system is
managed as a monorepo using [Turborepo](https://turbo.build/), enabling fast,
incremental builds and consistent workflows across multiple packages.
...
The root contains a `turbo.json` file that defines build, dev, lint, test and
publish pipelines across all packages.
...
angularOutputTarget({
  ...
  directivesProxyFile:
    '../angular/projects/library/src/lib/stencil-generated/components.ts',
  directivesArrayFile:
    '../angular/projects/library/src/lib/stencil-generated/index.ts',
