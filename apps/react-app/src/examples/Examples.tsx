...
function Examples() {
  return (
    <TkCard>
      ...
      <p>Komponentlerin birlikte ve daha kompleks kullanımlarını deneyebilmemiz için oluşturuldu.</p>

      <div className="grid grid-cols-6 gap-4 mt-4">
        <Link to="react-hook-form" className="p-4 border border-indigo-600 rounded-md text-center hover:bg-violet-100">
          React Hook Form
        </Link>
