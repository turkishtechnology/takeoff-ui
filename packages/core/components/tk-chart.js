  ...
  updateElements(points, start, count, mode) {
    ...
    for (let i = 0; i < pointsCount; ++i) {
      ...
      const vPixel = (properties[vAxis] =
        reset || nullData ? vScale.getBasePixel() : vScale.getPixelForValue(_stacked ? this.applyStack(vScale, parsed, _stacked) : parsed[vAxis], i));
...
var plugin_colors = {
  ...
  beforeLayout(chart, _args, options) {
    ...
    const containsColorDefenition =
      containsColorsDefinitions(datasets) || containsColorsDefinition(chartOptions) || (elements && containsColorsDefinitions(elements)) || containsDefaultColorsDefenitions();
...
function getDefaultOptionsForType(type) {
  ...
  switch (type) {
    case 'bar':
      options = lodashExports.merge({}, DEFAULT_CHART_OPTIONS, BAR_CHART_OPTIONS);
      break;
    case 'horizontal-bar':
      options = lodashExports.merge({}, DEFAULT_CHART_OPTIONS, HORIZONTAL_BAR_CHART_OPTIONS);
      break;
    case 'pie':
      options = lodashExports.merge({}, DEFAULT_CHART_OPTIONS, PIE_CHART_OPTIONS);
      break;
    case 'doughnut':
      options = lodashExports.merge({}, DEFAULT_CHART_OPTIONS, DOUGHNUT_CHART_OPTIONS);
      break;
    default:
      options = lodashExports.merge({}, DEFAULT_CHART_OPTIONS);
  }
  return options;
}
/*
...
const TkChart$1 = /*@__PURE__*/ proxyCustomElement(
  class TkChart extends H {
    ...
    mergeOptions() {
      ...
      this.internalOptions = lodashExports.merge({}, typeDefaults, this.options);
    }
    initChart() {
      if (this.chartRef) {
    ...
    render() {
      var _a, _b, _c;
      const title =
        (_c = (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.plugins) === null || _b === void 0 ? void 0 : _b.title) === null || _c === void 0
          ? void 0
          : _c.text;
      ...
      return h(
        'div',
        {
          key: 'f47736c69a376269fe227983d24c321bd7490d90',
        ...
        h('canvas', { 'key': '0f150a9bfc6d82cc260a391f603ae6514d8850ce', 'ref': el => (this.chartRef = el), 'role': 'img', 'aria-label': accessibilityLabel }),
      );
    }
    get el() {
      return this;
...
function defineCustomElement$1() {
  ...
  const components = ['tk-chart'];
  components.forEach(tagName => {
    switch (tagName) {
      case 'tk-chart':
        if (!customElements.get(tagName)) {
          customElements.define(tagName, TkChart$1);
        }
        break;
    }
  });
...
const TkChart = TkChart$1;
const defineCustomElement = defineCustomElement$1;

export { TkChart, defineCustomElement };
//# sourceMappingURL=tk-chart.js.map
