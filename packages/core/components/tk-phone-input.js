...
const tkPhoneInputCss =
  '@font-face{font-family:"Material Symbols Outlined";src:url("./assets/fonts/Material-Symbols-Outlined.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-outlined{font-family:"Material Symbols Outlined";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-outlined{font-variation-settings:"FILL" 0}.material-symbols-outlined.fill{font-variation-settings:"FILL" 1}@font-face{font-family:"Material Symbols Rounded";src:url("./assets/fonts/Material-Symbols-Rounded.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-rounded{font-family:"Material Symbols Rounded";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-rounded{font-variation-settings:"FILL" 0}.material-symbols-rounded.fill{font-variation-settings:"FILL" 1}@font-face{font-family:"Material Symbols Sharp";src:url("./assets/fonts/Material-Symbols-Sharp.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}.material-symbols-sharp{font-family:"Material Symbols Sharp";font-weight:normal;font-style:normal;font-size:24px;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:"liga";-webkit-font-smoothing:antialiased}.material-symbols-sharp{font-variation-settings:"FILL" 0}.material-symbols-sharp.fill{font-variation-settings:"FILL" 1}:host{display:block}.tk-phone-input{display:flex;flex-direction:column;gap:var(--input-external-label-large-container-gap);box-sizing:border-box}.tk-phone-input[aria-invalid] .tk-phone-input__wrapper{border-color:var(--states-danger-base)}.tk-phone-input[aria-invalid] .tk-phone-input__hint-text{color:var(--states-danger-base)}.tk-phone-input[aria-invalid] .tk-phone-input__hint i{color:var(--states-danger-base)}.tk-phone-input[aria-disabled] .tk-phone-input__wrapper{background-color:var(--background-lightest);border-color:var(--border-light)}.tk-phone-input[aria-disabled] .tk-phone-input__label,.tk-phone-input[aria-disabled] .tk-phone-input__hint-text{color:var(--text-sub-base);pointer-events:none}.tk-phone-input[aria-disabled] .tk-phone-input__input,.tk-phone-input[aria-disabled] .tk-phone-input__dropdown-button{color:var(--text-sub-base);pointer-events:none}.tk-phone-input[aria-disabled] .tk-phone-input__input::placeholder,.tk-phone-input[aria-disabled] .tk-phone-input__dropdown-button::placeholder{color:var(--text-sub-base)}.tk-phone-input[aria-readonly] .tk-phone-input__wrapper{background-color:var(--background-lightest);border-color:var(--border-light)}.tk-phone-input[aria-readonly] .tk-phone-input__label,.tk-phone-input[aria-readonly] .tk-phone-input__hint-text{color:var(--text-sub-base)}.tk-phone-input[aria-readonly] .tk-phone-input__input,.tk-phone-input[aria-readonly] .tk-phone-input__dropdown-button{color:var(--text-darkest);pointer-events:none}.tk-phone-input[aria-readonly] .tk-phone-input__input::placeholder,.tk-phone-input[aria-readonly] .tk-phone-input__dropdown-button::placeholder{color:var(--text-darkest)}.tk-phone-input--large .tk-phone-input__wrapper{height:var(--spacing-12xl);padding:var(--input-external-label-large-label-v-padding) var(--input-external-label-large-label-h-padding)}.tk-phone-input--large .tk-phone-input__label{font-size:var(--desktop-label-l-size);line-height:var(--desktop-label-l-line-height);padding:var(--input-external-label-large-label-v-padding) var(--input-external-label-large-label-h-padding)}.tk-phone-input--large .tk-phone-input__label-title{font-size:var(--desktop-label-l-size);line-height:var(--desktop-label-l-line-height)}.tk-phone-input--large .tk-phone-input__dropdown-menu{top:var(--spacing-12xl)}.tk-phone-input--large .tk-phone-input__dropdown-menu-list-item{font-size:var(--desktop-label-l-size);line-height:var(--desktop-label-l-line-height)}.tk-phone-input--base .tk-phone-input__wrapper{height:var(--spacing-10xl);padding:var(--input-external-label-base-label-v-padding) var(--input-external-label-base-label-h-padding)}.tk-phone-input--base .tk-phone-input__label{font-size:var(--desktop-label-m-base-size);line-height:var(--desktop-label-m-base-line-height);padding:var(--input-external-label-base-label-v-padding) var(--input-external-label-base-label-h-padding)}.tk-phone-input--base .tk-phone-input__label-title{font-size:var(--desktop-label-m-base-size);line-height:var(--desktop-label-m-base-line-height)}.tk-phone-input--base .tk-phone-input__dropdown-menu{top:var(--spacing-10xl)}.tk-phone-input--base .tk-phone-input__dropdown-menu-list-item{font-size:var(--desktop-label-m-base-size);line-height:var(--desktop-label-m-base-line-height)}.tk-phone-input--small .tk-phone-input__wrapper{height:var(--spacing-8xl);padding:var(--input-external-label-small-label-v-padding) var(--input-external-label-small-label-h-padding)}.tk-phone-input--small .tk-phone-input__label{font-size:var(--desktop-label-s-size);line-height:var(--desktop-label-s-line-height);padding:var(--input-external-label-small-label-v-padding) var(--input-external-label-small-label-h-padding)}.tk-phone-input--small .tk-phone-input__label-title{font-size:var(--desktop-label-s-size);line-height:var(--desktop-label-s-line-height)}.tk-phone-input--small .tk-phone-input__dropdown-menu{top:var(--spacing-8xl)}.tk-phone-input--small .tk-phone-input__dropdown-menu-list-item{font-size:var(--desktop-label-s-size);line-height:var(--desktop-label-s-line-height)}.tk-phone-input__label{display:flex;align-items:flex-start;box-sizing:border-box}.tk-phone-input__label-title{color:var(--text-darkest);font-family:var(--desktop-label-s-font, "Georgia");font-weight:var(--weight-medium)}.tk-phone-input__label-red-asterisk{color:var(--states-danger-base);font-size:var(--desktop-label-m-base-size);font-weight:var(--weight-regular);line-height:var(--desktop-label-s-line-height)}.tk-phone-input__wrapper{box-sizing:border-box;position:relative;display:flex;width:-webkit-fill-available;color:var(--text-darkest);font-family:var(--desktop-label-s-font, "Georgia");border-radius:var(--button-sizes-large-radius);border:var(--spacing-px) solid var(--border-light);background:var(--static-light)}.tk-phone-input__wrapper--focus{border:var(--spacing-px) solid var(--states-info-base)}.tk-phone-input__wrapper:hover{background-color:var(--background-lightest)}.tk-phone-input__dropdown{box-sizing:border-box}.tk-phone-input__dropdown-button{cursor:pointer;display:flex;align-items:center;width:max-content;height:100%;border:none;font-family:var(--desktop-label-s-font, "Georgia");font-size:var(--desktop-label-l-size);font-weight:var(--weight-medium);color:var(--text-darkest);background-color:transparent;padding-right:var(--input-external-label-large-label-h-padding)}.tk-phone-input__dropdown-button-selected{display:flex;align-items:center;gap:var(--spacing-xs);border-right:var(--spacing-px) solid var(--border-light)}.tk-phone-input__dropdown-button-dial-code{padding-right:var(--input-external-label-large-label-h-padding)}.tk-phone-input__dropdown-menu{position:absolute;left:var(--spacing-none);z-index:10;background:var(--static-light);border:var(--spacing-px) solid var(--border-light);border-radius:var(--button-sizes-large-radius);box-shadow:var(--effect-1-default-sm);width:var(--spacing-80xl);display:flex;flex-direction:column}.tk-phone-input__dropdown-menu-search{padding:var(--spacing-m-base)}.tk-phone-input__dropdown-menu-list{list-style:none;padding:var(--spacing-none);margin:var(--spacing-none) var(--spacing-m-base) var(--spacing-none) var(--spacing-none);max-height:var(--spacing-56xl);overflow-y:auto;}.tk-phone-input__dropdown-menu-list-item{display:flex;align-items:center;gap:var(--spacing-xs);padding:var(--input-external-label-base-input-v-padding) var(--spacing-4xl);cursor:pointer;transition:background-color 0.2s;font-family:var(--desktop-label-s-font, "Georgia")}.tk-phone-input__dropdown-menu-list-item:hover{background-color:var(--background-lightest)}.tk-phone-input__dropdown-menu-list-item-country-label{flex-grow:1;white-space:nowrap;color:var(--text-darkest);font-size:var(--size-sm)}.tk-phone-input__dropdown-menu-list-item-dial-id{color:var(--text-darkest);font-size:var(--desktop-label-m-base-size)}.tk-phone-input__dropdown-menu-list::-webkit-scrollbar{width:var(--spacing-l)}.tk-phone-input__dropdown-menu-list::-webkit-scrollbar-track{background:var(--background-lightest);border-radius:var(--radius-m-base)}.tk-phone-input__dropdown-menu-list::-webkit-scrollbar-thumb{background:var(--secondary-300);border-radius:var(--radius-m-base)}.tk-phone-input__dropdown-menu-list::-webkit-scrollbar-thumb:hover{background:var(--secondary-400)}.tk-phone-input__input{border:none;font-family:var(--desktop-label-s-font, "Georgia");font-size:var(--desktop-label-l-size);font-weight:var(--weight-medium);background-color:transparent;outline:none;color:var(--text-darkest);width:inherit}.tk-phone-input__input::placeholder{color:var(--text-sub-base)}.tk-phone-input__hint{color:var(--text-base);line-height:var(--desktop-label-s-line-height);font-size:var(--desktop-label-s-size);font-weight:300;display:flex;align-items:center;gap:var(--spacing-m-base)}.tk-phone-input__hint-icon{font-size:var(--size-base);width:var(--size-base);height:var(--size-base);color:var(--icon-base)}';
...
const TkPhoneInput$1 = /*@__PURE__*/ proxyCustomElement(
  class TkPhoneInput extends H {
    ...
    static get style() {
      return tkPhoneInputCss + flagCss;
    }
  },
  [
    64,
