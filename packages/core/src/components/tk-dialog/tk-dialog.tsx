...
export class TkDialog implements ComponentInterface {
  ...
  private createHeader() {
    if (this.showHeader) {
      if (this.hasHeaderSlot) {
        ...
        return (
          <div class={headerClasses} data-testid={getDataTestId(this.dataTestid, 'header-container')}>
            <div class="tk-dialog-header-content" data-testid={getDataTestId(this.dataTestid, 'header')}>
              {this.showVariantSign && (
                <tk-icon
                  sign
                  dataTestid={getDataTestId(this.dataTestid, 'sign-icon')}
                  size="xlarge"
                  {...getIconElementProps(this.getVariantIcon(), { class: classNames('fill tk-dialog-sign-icon'), variant: this.variant }, 'rounded', 'span')}
                />
              )}
              <div class="tk-dialog-title-container" data-testid={getDataTestId(this.dataTestid, 'title-container')}>
                {this.subheader && (
                  <span class="tk-dialog-subtitle" data-testid={getDataTestId(this.dataTestid, 'subheader')}>
                    {this.subheader}
                  </span>
                )}
                {this.header && (
                  <span class="tk-dialog-title" data-testid={getDataTestId(this.dataTestid, 'title')}>
                    {this.header}
                  </span>
                )}
              </div>
            ...
            {this.showCloseButton && (
              <tk-button
                ...
                dataTestid={getDataTestId(this.dataTestid, 'close-button')}
              ></tk-button>
            )}
          </div>
        );
  ...
  private createContent() {
    if (this.hasContentSlot) {
      return (
        <div class="tk-dialog-content" data-testid={getDataTestId(this.dataTestid, 'content')}>
  ...
  private createFooter() {
    if (this.hasFooterSlot) {
      ...
      return (
        <div class="tk-dialog-footer" data-testid={getDataTestId(this.dataTestid, 'footer')}>
  ...
  private renderMask() {
    ...
    return (
      <div class={maskClasses} data-testid={getDataTestId(this.dataTestid, 'mask')}>
        <div class="tk-dialog-overlay" onClick={() => this.handleOverlayClick()} data-testid={getDataTestId(this.dataTestid, 'overlay')}></div>
        {dialog}
      </div>
    );
  }
