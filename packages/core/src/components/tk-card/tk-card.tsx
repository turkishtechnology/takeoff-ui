...
export class TkCard implements ComponentInterface {
  ...
  private createHeader() {
    ...
    if (this.hasHeaderSlot) {
      ...
      return (
        <div
          {...getDataTestidAttribute(this.dataTestid, 'header-container')}
        ...
        >
          <div class="tk-card-header-content" {...getDataTestidAttribute(this.dataTestid, 'header')}>
            {this.hasAvatarSlot ? (
              <slot name="avatar"></slot>
            ) : (
              <Fragment>
                {this.showAvatar && (
                  <div class="tk-card-avatar" {...getDataTestidAttribute(this.dataTestid, 'avatar-container')}>
                    {' '}
                    <tk-avatar {...this.avatarProps} {...getDataTestidAttribute(this.dataTestid, 'avatar')}></tk-avatar>
                  </div>
                )}
              </Fragment>
            )}
            <div class="tk-card-title-container" {...getDataTestidAttribute(this.dataTestid, 'title-container')}>
              {this.subheader && (
                <span class="tk-card-subtitle" {...getDataTestidAttribute(this.dataTestid, 'subtitle')}>
                  {this.subheader}
                </span>
              )}
              {this.header && (
                <span class="tk-card-title" {...getDataTestidAttribute(this.dataTestid, 'title')}>
                  {this.header}
                </span>
              )}
            </div>
          ...
          {this.hasHeaderActionSlot ? (
            ...
            this.showMenuButton && (
              <tk-button
                ...
                dataTestid={getDataTestidProp(this.dataTestid, 'header-menu-button')}
              ></tk-button>
            )
          )}
        </div>
  ...
  private createImage() {
    ...
    return (
      <div class={imageClasses} {...getDataTestidAttribute(this.dataTestid, 'image-container')}>
        <img src={this.image} alt="Card image" {...getDataTestidAttribute(this.dataTestid, 'image')} />
  ...
  private createContent() {
    if (this.hasContentSlot) {
      ...
      return (
        <div class="tk-card-content" style={this.contentStyle} {...getDataTestidAttribute(this.dataTestid, 'content')}>
          <slot></slot>
        </div>
      );
    }
  ...
  private createFooter() {
    if (this.hasFooterSlot) {
      ...
      return (
        <div
          {...getDataTestidAttribute(this.dataTestid, 'footer')}
    ...
    if (imageOption === 'top') {
      ...
      return (
        <Fragment>
          ...
          <div class="tk-card-horizontal-has-image-container" {...getDataTestidAttribute(this.dataTestid, 'horizontal-has-image-container')}>
            {header}
            {content}
            {footer}
          </div>
